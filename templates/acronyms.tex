...
\newacronym{lwc}{LWC}{LightWeight Cryptography}
\newacronym{lwca}{LWCA}{LightWeight Cryptography Algorithm}
\newacronym{kp}{KP}{Cryptographical Primitive}
\newacronym{xof}{XOF}{eXtendable-Output Function}
\newacronym{tun}{TUN}{virtual software TUNnel interface on L3 layer}
\newacronym{tap}{TAP}{virtual software TAP interface on L2 layer}
